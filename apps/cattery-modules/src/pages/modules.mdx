---
title: Modules
description: Complete module reference for cattery — all 244+ modules with options
---
...
| `cattery.desktop.addons.chromium-support` | Wayland Chromium/Electron (NIXOS_OZONE_WL=1) | `enable` |
...
| `cattery.services.postgresql.secrets` | Encrypted postgresql/pg_hba/pg_ident configs | Auto-enabled with secrets |
...
| Module | Description | Options |
|---|---|---|
| `cattery.cli-apps.ssh` | SSH known_hosts management | `knownHostsFileNames`, `knownHostsFiles` |
| `cattery.cli-apps.ssh.secrets` | Encrypted SSH known_hosts | Auto-enabled with secrets |
