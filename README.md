...
| **purr** | [purr.nixcafe.org](https://purr.nixcafe.org) | `apps/purr-docs/` | 9 pages — quick start, flake-parts, mkFlake, modules, directory structure, systems/homes, host meta, hydraJobs, 40-function API reference |
